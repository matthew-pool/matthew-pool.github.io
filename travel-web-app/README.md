...
Welcome to the main repository for the **Travlr Getaways** web application. This project demonstrates the evolution of a full-stack travel platform, tracking its migration from a traditional Express.js and MongoDB backend to a modernized, containerized architecture using the LoopBack API framework and AWS DynamoDB.
