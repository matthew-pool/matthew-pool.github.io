...
public class MainTest {
    ...
    public void testInvalidInputAndQuit() {
    ...
    public void testGetAcquisitionCountry() {
        ...
        // Empty input, follwed by valid input
    ...
    public void testIntakeNewDog() {
        ...
        // Existing name
        String simulateExistingDog = "Billy Bob\n";
        // Simulate user input
    ...
    public void testIntakeNewMonkey() {
        ...
        // Existing name
        String simulateExistingMonkey = "Jacko\n";
        // Simulate user input
