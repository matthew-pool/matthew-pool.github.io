...
This is a robust, text-based command-line application written in Java that manages the intake and tracking of rescue animals. The user can add new dogs and monkeys (and their specific attributes) to a persistent local database utilizing MapDB. The system also allows the user to reserve animals for specific service locations and output formatted, color-coded lists of dogs, monkeys, or all available non-reserved animals directly to the console.<br>
...
Implemented Comprehensive JUnit Testing:<br>
![JUnit test coverage with 83% of lines and 75% of branches covered](images/new1.png)<br>
![Comprehensive JUnit tests run with 0 failures](images/new3.png)<br>
